...
describe("Sidebar", () => {
  ...
  it("renders the Demeter Santé logo in the branded header", () => {
    ...
    expect(screen.getByRole("link", { name: "Queue Rapport" })).toHaveAttribute("href", "/report-queue")
  ...
  it("hides backend errors for non super admins", () => {
    ...
    expect(screen.queryByRole("link", { name: "Queue Rapport" })).not.toBeInTheDocument()
